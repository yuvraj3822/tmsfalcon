 ...
 */
public class TruckDocumentList extends Fragment implements DocumentAdapter.progressCallback {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_truck_document_list, container, false);
        initIds(view);
    ...
    private void getDocumentsList() {
        ...
        String tag_json_obj = "truck_documents_tag";
        String url = UrlController.TRUCK_DOCUMENTS+"/"+truck_id;
                        ...
                        try {
                            ...
                            if(status){
                               ...
                               if(dataArray != null && dataArray.length() > 0){
                                   ...
                                   if (doc_arrayList!=null && getActivity()!=null) {
                                       if (!getActivity().isDestroyed() && isAdded()) {
                                           documentAdapter = new DocumentAdapter(getActivity(), doc_arrayList);
                                           documentAdapter.registerProgressCallback(TruckDocumentList.this);
