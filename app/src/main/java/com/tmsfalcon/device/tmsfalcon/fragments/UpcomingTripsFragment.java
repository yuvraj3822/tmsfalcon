...
public class UpcomingTripsFragment extends Fragment{
    ...
    private boolean isDataAddedToScroll = false;
...
//                Log.e("visibleItemCount: ",": "+visibleItemCount+ " , "+firstVisibleItem);
//
//
//                if (lastInScreen>= 10){
//
...
//    }
    ...
    private void initIds(View view) {
        ...
        tripsListView = view.findViewById(R.id.upcomingTripsListView);
       ...
       // progressBar.setIndeterminateTintList(ColorStateList.valueOf(colorCodeDark));
        ...
        tripAdapter = new TripAdapter(getActivity(),arrayList,"upcoming_trips");
...
//        setScrollEvent();
    ...
    public void getTripsList(int page) {
        ...
        Log.e("Upcoming Page",": "+page);
        String tag_json_obj = "upcoming_trips_list";
        String url = UrlController.UPCOMING_TRIPS;
        showProgessBar();
        Map<String, Integer> params = new HashMap<>();
        params.put("limit", setLimit());
        params.put("offset", page);
        Log.e("Upcoming Req",""+params.toString());
...
//                                    }
                                    isDataAddedToScroll = true;
                                } else {
                                    isDataAddedToScroll = false;
                                }
//                                else{
//                                    if(arrayList.size() == 0){
