...
public class ReportedAccidentScreenFiveFormData extends NavigationBaseActivity implements Runnable{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View contentView = inflater.inflate(R.layout.activity_reported_accident_screen_five_form_data, null, false);
    ...
    public void init(){
        ...
        sessionManager = new SessionManager(ReportedAccidentScreenFiveFormData.this);
        customValidator = new CustomValidator(ReportedAccidentScreenFiveFormData.this);
        permissionManager = new PermissionManager();
        accidentWitnessTable = new AccidentWitnessTable(ReportedAccidentScreenFiveFormData.this);
    }
    ...
    void showPopUp(){
        AlertDialog.Builder dialogBuilder = new AlertDialog.Builder(ReportedAccidentScreenFiveFormData.this);
        LayoutInflater inflater = ReportedAccidentScreenFiveFormData.this.getLayoutInflater();
        View dialogView = inflater.inflate(R.layout.dialog_accident_witness, null);
        dialogBuilder.setView(dialogView);

        ZoomLinearLayout zoomLinearLayout = dialogView.findViewById(R.id.body_layout);
        zoomLinearLayout.init(ReportedAccidentScreenFiveFormData.this);
        ...
        seekBar.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            public void onProgressChanged(SeekBar seekBar, int progress, boolean b) {
                ...
                if (x != 0 && mediaPlayer != null && !mediaPlayer.isPlaying()) {
                    ...
                    ReportedAccidentScreenFiveFormData.this.seekBar.setProgress(0);
                }
            }
...
//                    adapter = new AccidentWitnessListAdapter(ReportedAccidentScreenFiveFormData.this,witness_arrayList);
                    ...
                    Toast.makeText(ReportedAccidentScreenFiveFormData.this,"Witness Saved",Toast.LENGTH_LONG).show();
                }
    ...
    void goToNext(){
        Intent i = new Intent(ReportedAccidentScreenFiveFormData.this,ReportedAccidentScreenSix.class);
        startActivity(i);
    }
