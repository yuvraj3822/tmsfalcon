...
import com.tmsfalcon.device.tmsfalcon.customtools.ImageDetectionProperties;
import com.tmsfalcon.device.tmsfalcon.customtools.ScanConstants;
...
public class ScanSurfaceView extends FrameLayout implements SurfaceHolder.Callback {
    ...
    public boolean turnOnFlash = false;
    ...
    private Camera.Parameters getParameters(){
        ...
        if (Build.VERSION.SDK_INT > Build.VERSION_CODES.P) {
            if (turnOnFlash){
                ...
                parameters.setFlashMode(turnOnFlash ? Camera.Parameters.FLASH_MODE_TORCH : Camera.Parameters.FLASH_MODE_OFF);
        ...
        public void onPreviewFrame(byte[] data, Camera camera) {
            if (null != camera) {
                try {
                    ...
                    Mat yuv = new Mat(new Size(pictureSize.width, pictureSize.height ), CV_8UC1);
                    yuv.put(0, 0, data);
    ...
    private final Camera.PictureCallback pictureCallback = new Camera.PictureCallback() {
        ...
        public void onPictureTaken(byte[] data, Camera camera) {
           ...
           /* final BitmapFactory.Options options = new BitmapFactory.Options();
            ...
            iScanner.onPictureClicked(bitmap,data);
