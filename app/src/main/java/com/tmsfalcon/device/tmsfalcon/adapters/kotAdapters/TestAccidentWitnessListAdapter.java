 ...
 */
public class TestAccidentWitnessListAdapter extends BaseAdapter{
    ...
    TestAccidentWitnessListAdapter.ViewHolder holder = null;
    AccidentModuleDb db;
    WitnessFormAccident wfaSchema;

    public TestAccidentWitnessListAdapter(Activity activity, ArrayList<AccidentWitnessModel> data, AccidentModuleDb db, WitnessFormAccident wfaSchema) {
        this.activity = activity;
        this.mData = data;
        mInflater = (LayoutInflater)activity.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        sessionManager = new SessionManager(activity);
        this.db = db;
        this.wfaSchema = wfaSchema;
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            holder = new TestAccidentWitnessListAdapter.ViewHolder();
            ...
            holder = (TestAccidentWitnessListAdapter.ViewHolder)convertView.getTag();
