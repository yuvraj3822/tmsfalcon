...
class SearchableDialog {
    ...
    fun show() {
        ...
        val view = activity.layoutInflater.inflate(R.layout.search_dialog_custom, null)
        ...
        searchBox.addTextChangedListener(object : TextWatcher {
            ...
            override fun afterTextChanged(editable: Editable) {
                ...
                if (filteredValues.size == 0){
                    filteredValues.add(SearchListItem(-2,searchBox.text.toString()))
                }
                Log.e("filtered values",": "+filteredValues.size)
