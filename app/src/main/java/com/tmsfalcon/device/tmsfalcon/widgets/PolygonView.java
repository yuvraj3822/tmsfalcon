...
public class  PolygonView extends FrameLayout {
    ...
    private void initPaint() {
        ...
        paintLine = new Paint();
        paintLine.setColor(getResources().getColor(R.color.crop_border_color));
    ...
    public void setPoints(Map<Integer, PointF> pointFMap) {
        if (pointFMap.size() == 4) {
            Log.e("in if","setPoints");
            setPointsCoordinates(pointFMap);
        }
        else{
            Log.e("in else","setPoints");
        }
    }
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        canvas.drawLine(pointer1.getX() + (pointer1.getWidth() / 2), pointer1.getY() + (pointer1.getHeight() / 2), pointer3.getX() + (pointer3.getWidth() / 2), pointer3.getY() + (pointer3.getHeight() / 2), paintLine);
        canvas.drawLine(pointer1.getX() + (pointer1.getWidth() / 2), pointer1.getY() + (pointer1.getHeight() / 2), pointer2.getX() + (pointer2.getWidth() / 2), pointer2.getY() + (pointer2.getHeight() / 2), paintLine);
        canvas.drawLine(pointer2.getX() + (pointer2.getWidth() / 2), pointer2.getY() + (pointer2.getHeight() / 2), pointer4.getX() + (pointer4.getWidth() / 2), pointer4.getY() + (pointer4.getHeight() / 2), paintLine);
        canvas.drawLine(pointer3.getX() + (pointer3.getWidth() / 2), pointer3.getY() + (pointer3.getHeight() / 2), pointer4.getX() + (pointer4.getWidth() / 2), pointer4.getY() + (pointer4.getHeight() / 2), paintLine);
        midPointer13.setX(pointer3.getX() - ((pointer3.getX() - pointer1.getX()) / 2));
        midPointer13.setY(pointer3.getY() - ((pointer3.getY() - pointer1.getY()) / 2));
        midPointer24.setX(pointer4.getX() - ((pointer4.getX() - pointer2.getX()) / 2));
        midPointer24.setY(pointer4.getY() - ((pointer4.getY() - pointer2.getY()) / 2));
    ...
    private ImageView getImageView(int x, int y) {
        ...
        imageView.setImageResource(R.drawable.circle_blue_border);
        imageView.setX(x);
        imageView.setY(y);
        ...
        public boolean onTouch(View v, MotionEvent event) {
            ...
            switch (eid) {
                ...
                case MotionEvent.ACTION_DOWN:
                    AppController.allDraggedPointsStack.push(new PolygonPoints(new PointF(pointer1.getX(), pointer1.getY()),
                ...
                case MotionEvent.ACTION_UP:
                    ...
                    if (isValidShape(getPoints()) && isValidPointer1() && isValidPointer2() && isValidPointer3() && isValidPointer4()) {
                        ...
                        AppController.allDraggedPointsStack.pop();
                        color = getResources().getColor(R.color.crop_color);
