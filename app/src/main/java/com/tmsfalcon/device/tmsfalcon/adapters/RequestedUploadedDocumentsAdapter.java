...
public class RequestedUploadedDocumentsAdapter extends BaseAdapter implements ManagePdf.downloadPdfInterface {
    ...
    String TAG = RequestedUploadedDocumentsAdapter.this.getClass().getSimpleName();

    public void registerProgressCallback(progressCallback Mcallback){
        callback = Mcallback;
    }

    public RequestedUploadedDocumentsAdapter(Activity activity, ArrayList<DocumentRequestModel> data) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        RequestedUploadedDocumentsAdapter.ViewHolder holder = null;
        int type = getItemViewType(position);
        final DocumentRequestModel model = mData.get(position);
        if (convertView == null) {
            holder = new RequestedUploadedDocumentsAdapter.ViewHolder();
            convertView = mInflater.inflate(R.layout.requested_uploaded_document_list_item, null);
            ...
            holder = (RequestedUploadedDocumentsAdapter.ViewHolder)convertView.getTag();
        }
    ...
    public void downloadingProcess(DocumentRequestModel model){
        if(model.getFile_url() != null){
            /*Log.e(TAG,"type:"+model.getFile_type()+" url:"+model.getFile_url());
            boolean isUrlReachable = Utils.isUrlReachable(activity,model.getFile_url());
            Log.e(TAG,"isUrlReachable:"+isUrlReachable);*/
            if(model.getFile_type() != "false"){
           ...
           /* Picasso.with(activity)
                    ...
                    if(model.getFile_url()!= "false") {
                        ...
                        openWEbView.putExtra("file_name", "uploaded-document-" + model.getDocument_request_id());
    ...
    public static class ViewHolder {
        ...
        TextView document_name,due_date,comment,status,load_number;
        Button view;
        View status_circle;
    }
