...
public class QueueAdapter extends BaseAdapter {
    ...
    public QueueAdapter(Activity activity,Context context, ArrayList<String> list,ArrayList<String> idList){
        this.context = context;
        this.imagesList = list;
        this.dbIdList = idList;
        this.activity = activity;
        mInflater = (LayoutInflater)context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        db = new RequestedDocumentsTable(activity);
    }
    @Override
    public int getCount() {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        QueueAdapter.ViewHolder holder = null;
        if (convertView == null) {
            holder = new QueueAdapter.ViewHolder();
            ...
            holder = (QueueAdapter.ViewHolder)convertView.getTag();
        }
        File fileLocation = null;
        try{
            fileLocation = new File(imagesList.get(position));
        }
        catch (Exception e){
       ...
       // Picasso.with(context).load(fileLocation).into(holder.imageView);
        ...
        holder.imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                viewPager.setCurrentItem(final_position);
