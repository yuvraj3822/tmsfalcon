...
public class UpdateBasicAccidentData extends NavigationBaseActivity {
    ...
    AccidentBasicDetailsModel data_getter;
    String accident_id = "";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        //setContentView(R.layout.activity_update_basic_accident_data);
        LayoutInflater inflater = (LayoutInflater) this.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        View contentView = inflater.inflate(R.layout.activity_update_basic_accident_data, null, false);
        drawer.addView(contentView, 0);
        ButterKnife.bind(this);
        db = new AccidentBasicDetails(UpdateBasicAccidentData.this);
        data_getter = new AccidentBasicDetailsModel();
        accident_id = getIntent().getStringExtra("accident_id");
        Log.e("accident_id"," is "+accident_id);
        data_getter = db.getAccidentBasicDetailById(Integer.parseInt(accident_id));
        sessionManager = new SessionManager();
        customValidator = new CustomValidator(UpdateBasicAccidentData.this);
    ...
    private void setData(){
        accident_date.setText(data_getter.getAccident_date());
        accident_time.setText(data_getter.getAccident_time());
        driver_employer_name.setText(data_getter.getEmployer_name());
        driver_employer_phone_no.setText(data_getter.getEmployer_phone_number());
        driver_employer_insurance_provider.setText(data_getter.getEmployer_insurance_provider());
        driver_employer_insurance_policy_number.setText(data_getter.getEmployer_insurance_policy_number());
        setVehicleData();
    ...
    private void setVehicleData(){
        ...
        accidentVehicleDetailsModelArrayList = db.getVehicleDetailById(Integer.parseInt(accident_id));
        for(final AccidentVehicleDetailsModel model : accidentVehicleDetailsModelArrayList){
            ...
            insurance_provider_textview.setText(model.getVehicle_insurance_provider());
            insurance_policy_number_textview.setText(model.getVehicle_insurance_policy_number());
            dot_number_textview.setText(model.getVehicle_dot_number());
            vehicle_registration_textview.setText(model.getVehicle_registration_number());
            vehicle_license_no_textview.setText(model.getVehicle_license_number());

            vehicle_owner_name_textview.setText(model.getVehicle_owner_name());
            vehicle_owner_phone_textview.setText(model.getVehicle_owner_phone_number());
            vehicle_owner_insurance_provider_textview.setText(model.getVehicle_owner_insurance_provider());
            vehicle_owner_insurance_policy_textview.setText(model.getVehicle_owner_insurance_policy_number());

            cancel_icon.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    vehicle_detail_container.removeView((View) view.getParent());
                    //vehicleDetailArrayList.remove(model);
                    db.delVehicleBasicByPrimaryId(String.valueOf(model.getId()));
                }
            });
        }
    ...
    private void saveDataToDb(){
        ...
        if(isFormValid){
            ...
            accidentBasicDetailsModel.setId(Integer.parseInt(accident_id));
            ...
            db.updateAccidentBasicDetails(accidentBasicDetailsModel);

            for (AccidentVehicleDetailsModel accidentVehicleDetailsModel : vehicleDetailArrayList) {
                accidentVehicleDetailsModel.setAccident_report_id(Integer.parseInt(accident_id));
                db.saveVehicleDetails(accidentVehicleDetailsModel);
            }
            Intent i = new Intent(UpdateBasicAccidentData.this, UpdateAccidentWitnessData.class);
            int accidentId = Integer.parseInt(accident_id);
            i.putExtra("accident_id",accidentId);
            startActivity(i);
        }
    }
    ...
    void setPickUpDatePicker(){
        ...
        dpd.show(UpdateBasicAccidentData.this.getFragmentManager(), "DatePickerDialog");
    ...
    void setincidentTime(){
        ...
        tpd.show(UpdateBasicAccidentData.this.getFragmentManager(),"TimePickerDialog");
    }
